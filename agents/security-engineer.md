...
| Agent | Interface |
|-------|-----------|
| core-bundler-engineer | Review file operations, path handling |
| cli-engineer | Review input validation, error messages |
| test-engineer | Ensure security tests exist |
| documentation-author | Document security model |
| release-engineer | Ensure secure release process |
| oss-governance-lead | Create SECURITY.md |
| code-reviewer | Flag security concerns in reviews |
