...
export class PackageAssembler {
  ...
  async assemble(newVersion: string | undefined): Promise<{ members: MonorepoPackage[]; devMembers: MonorepoPackage[] }> {
    ...
    return { members: closure.members, devMembers: closure.devMembers }
  }
}
